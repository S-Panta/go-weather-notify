...
func notification(title string, message string, iconPath string) {
...
func main() {
	...
	notification(response.Weather[0].Condition, response.Weather[0].Description, response.Weather[0].Icon)
}
